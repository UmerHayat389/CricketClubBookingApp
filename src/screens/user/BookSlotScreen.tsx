...
// ─── Toast Component ──────────────────────────────────────────────
const Toast = ({ visible, message, type }: { visible: boolean; message: string; type: 'error' | 'success' | 'info' }) => {
  ...
  return (
    <Animated.View style={[toastStyles.container, { opacity, transform: [{ translateY }], backgroundColor: c.bg, borderLeftColor: c.border }]}>
...
const BookSlotScreen = ({ navigation }: any) => {
  ...
  // When duration changes, trim selected slots to allowed count
  useEffect(() => {
    const maxSlots = selectedDuration.slots;
    if (selectedSlots.length > maxSlots) {
      setSelectedSlots(selectedSlots.slice(0, maxSlots));
    }
  }, [selectedDuration]);
  ...
  const handleSlotPress = (slot: string) => {
    ...
    if (selectedSlots.length > 0) {
      const allSorted = [...selectedSlots, slot].sort((a, b) => ALL_SLOTS.indexOf(a) - ALL_SLOTS.indexOf(b));
  ...
  const handleConfirmBooking = () => {
    ...
    if (selectedSlots.length < selectedDuration.slots) {
      showToast(`Please select ${selectedDuration.slots} consecutive slots for ${selectedDuration.label}`, 'info');
      return;
    }
    ...
    <View style={styles.container}>
      ...
      <View style={styles.header}>
        ...
        <TouchableOpacity style={styles.myBookingsBtn} onPress={() => navigation.navigate('Bookings')}>
          <Icon name="calendar-outline" size={16} color="#0A8F3C" />
      ...
      <ScrollView showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.section}>
          <View style={styles.sectionHeader}>
            ...
            <View style={styles.monthBadge}>
              <Icon name="calendar-outline" size={14} color="#0A8F3C" />
              <Text style={styles.monthText}>{selectedDate.monthName} {selectedDate.year}</Text>
              <Icon name="chevron-down" size={14} color="#0A8F3C" />
            </View>
          </View>
            ...
            {DURATIONS.map(d => {
              ...
              return (
                ...
                >
                  ...
                  {active && <Icon name="checkmark-circle" size={16} color="#0A8F3C" style={{ marginLeft: 6 }} />}
                </TouchableOpacity>
              );
            })}
          </ScrollView>
        ...
        <View style={styles.section}>
          ...
          <View style={styles.fieldRow}>
            ...
            />
            {name.length > 0 && <Text style={styles.fieldValue}>{name}</Text>}
          </View>
          ...
          <View style={styles.fieldRow}>
            ...
            />
            {phone.length > 0 && <Text style={styles.fieldValue}>{phone}</Text>}
          </View>
          ...
          <View style={styles.fieldRow}>
            ...
            <View style={styles.counter}>
              <TouchableOpacity style={styles.counterBtn} onPress={() => setPlayers(Math.max(1, players - 1))}>
                <Text style={styles.counterBtnText}>−</Text>
              </TouchableOpacity>
              <Text style={styles.counterVal}>{players}</Text>
              <TouchableOpacity style={styles.counterBtn} onPress={() => setPlayers(players + 1)}>
                <Text style={styles.counterBtnText}>+</Text>
              </TouchableOpacity>
            </View>
          </View>
        ...
        <View style={styles.section}>
          ...
          <View style={styles.summaryRow}>
            <Text style={styles.summaryLabel}>
              Price (PKR {PRICE_PER_HOUR.toLocaleString()} × {selectedDuration.label})
            </Text>
          ...
          <View style={styles.modalBox}>
            ...
            <View style={styles.accountBox}>
              ...
              <View style={styles.accountRow}>
                <Text style={styles.accountKey}>Account Title</Text>
                <Text style={styles.accountVal}>Cricket Club</Text>
              </View>
              <View style={styles.accountRow}>
                <Text style={styles.accountKey}>Bank</Text>
                <Text style={styles.accountVal}>HBL</Text>
              </View>
              <View style={styles.accountRow}>
                <Text style={styles.accountKey}>Account No.</Text>
                <Text style={styles.accountVal}>1234-5678-9012</Text>
              </View>
            </View>
...
const styles = StyleSheet.create({
  ...
  myBookingsBtn: { flexDirection: 'row', alignItems: 'center', gap: 4, backgroundColor: '#F0FFF6', paddingHorizontal: 10, paddingVertical: 6, borderRadius: 20, borderWidth: 1, borderColor: '#C8EDD8' },
  ...
  dayCard: {
    ...
    borderRadius: 14, borderWidth: 1.5, borderColor: '#EBEBEB', marginRight: 8, minWidth: 66,
  },
  ...
  slotCard: {
    alignItems: 'center', paddingHorizontal: 14, paddingVertical: 12,
    borderRadius: 12, borderWidth: 1.5, borderColor: '#EBEBEB', marginRight: 8, minWidth: 94,
  },
  ...
  selectedSlotInfo: {
    ...
    backgroundColor: '#F0FFF6', padding: 10, borderRadius: 10, marginTop: 12,
  },
  ...
  durationCard: {
    ...
    borderRadius: 12, borderWidth: 1.5, borderColor: '#EBEBEB', marginRight: 8,
  },
  ...
  bottomBar: {
    ...
    flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between',
    backgroundColor: '#fff', paddingHorizontal: 20, paddingVertical: 16, paddingBottom: 30,
  ...
  confirmBtn: {
    ...
    backgroundColor: '#0A8F3C', paddingHorizontal: 22, paddingVertical: 15, borderRadius: 14,
  },
  ...
  uploadBtn: {
    ...
    borderWidth: 1.5, borderColor: '#0A8F3C', borderStyle: 'dashed',
